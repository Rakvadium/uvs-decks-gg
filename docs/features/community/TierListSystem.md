...
These are defined centrally in [shared/app-config.ts](../../../shared/app-config.ts).
...
All ranking constants live in [shared/app-config.ts](../../../shared/app-config.ts).
...
Helpers live in [shared/app-config.ts](../../../shared/app-config.ts):
...
- `rankingScope`
- `rankingScopeKey`
- `selectedSetCodes` (normalized set pool used for scope keys and UI filtering)
- optional `poolScopes` (`setCode` + `cardType` pairs) when a more specific pool is requested
- optional `listModerationStatus` (`pending` / `approved` / `rejected`) for list-level moderation

These fields live in the `tierLists` table schema in [convex/schema.ts](../../../convex/schema.ts).
...
- [src/components/community/tier-lists/](../../../src/components/community/tier-lists)

Important areas:

- browser/create flow
  - [page-view/hook.ts](../../../src/components/community/tier-lists/page-view/hook.ts)
  - [page-view/create-dialog.tsx](../../../src/components/community/tier-lists/page-view/create-dialog.tsx)
- detail/editor flow
  - [detail-view/hook.ts](../../../src/components/community/tier-lists/detail-view/hook.ts)
  - [detail-view/top-bar.tsx](../../../src/components/community/tier-lists/detail-view/top-bar.tsx)
  - [detail-view/board.tsx](../../../src/components/community/tier-lists/detail-view/board.tsx)
  - [detail-view/lane-row.tsx](../../../src/components/community/tier-lists/detail-view/lane-row.tsx)
- feed/browser cards
  - [feed/content.tsx](../../../src/components/community/tier-lists/feed/content.tsx)
  - [feed/hook.ts](../../../src/components/community/tier-lists/feed/hook.ts)
  - [page-view/browser-card.tsx](../../../src/components/community/tier-lists/page-view/browser-card.tsx)

Community rankings view:

- exposed inside the `Rankings` tab on [src/app/(app)/community/tier-lists/page.tsx](../../../src/app/(app)/community/tier-lists/page.tsx)
- rendered by [src/components/community/community-rankings-view.tsx](../../../src/components/community/community-rankings-view.tsx)
- the legacy [src/app/(app)/community/rankings/page.tsx](../../../src/app/(app)/community/rankings/page.tsx) route now redirects into the merged tier-list experience

## Create Flow

Users create a tier list from the tier-list browser dialog.

The create dialog lives in [create-dialog.tsx](../../../src/components/community/tier-lists/page-view/create-dialog.tsx) and presents three options:
...
The detail model lives in [detail-view/hook.ts](../../../src/components/community/tier-lists/detail-view/hook.ts).
...
Users can change scope from the detail top bar in [detail-view/top-bar.tsx](../../../src/components/community/tier-lists/detail-view/top-bar.tsx).
...
Cards are selected primarily by set codes (`selectedSetCodes`). Optional `poolScopes` can further constrain the pool by card type. The editor derives the working pool in [detail-view/hook.ts](../../../src/components/community/tier-lists/detail-view/hook.ts) by filtering the cached card catalog.
...
Saving happens through [convex/tierLists.ts](../../../convex/tierLists.ts).
...
The implementation lives in [convex/communityRankings.ts](../../../convex/communityRankings.ts).
...
Aggregate computation lives in [convex/communityRankings.ts](../../../convex/communityRankings.ts).
...
- `listModerationStatus` exists on lists, but ranking eligibility currently keys off publicity + canonical ranked structure + scope (not moderation status)
- comments/likes are product surfaces around tier lists; they are not part of the ranking math documented here

## Tuning Guidance

If ranking behavior needs to change, start in [shared/app-config.ts](../../../shared/app-config.ts), not in feature code.
...
- [shared/app-config.ts](../../../shared/app-config.ts)

Convex:

- [convex/schema.ts](../../../convex/schema.ts)
- [convex/validators.ts](../../../convex/validators.ts)
- [convex/tierLists.ts](../../../convex/tierLists.ts)
- [convex/communityRankings.ts](../../../convex/communityRankings.ts)

Community browser/create:

- [src/components/community/tier-lists/page-view/hook.ts](../../../src/components/community/tier-lists/page-view/hook.ts)
- [src/components/community/tier-lists/page-view/create-dialog.tsx](../../../src/components/community/tier-lists/page-view/create-dialog.tsx)
- [src/components/community/tier-lists/page-view/top-bar.tsx](../../../src/components/community/tier-lists/page-view/top-bar.tsx)

Community detail/editor:

- [src/components/community/tier-lists/detail-view/hook.ts](../../../src/components/community/tier-lists/detail-view/hook.ts)
- [src/components/community/tier-lists/detail-view/top-bar.tsx](../../../src/components/community/tier-lists/detail-view/top-bar.tsx)
- [src/components/community/tier-lists/detail-view/board.tsx](../../../src/components/community/tier-lists/detail-view/board.tsx)
- [src/components/community/tier-lists/detail-view/lane-row.tsx](../../../src/components/community/tier-lists/detail-view/lane-row.tsx)

Rankings UI:

- [src/app/(app)/community/tier-lists/page.tsx](../../../src/app/(app)/community/tier-lists/page.tsx)
- [src/components/community/community-rankings-view.tsx](../../../src/components/community/community-rankings-view.tsx)
