...
function DeckGridItemCard() {
  ...
  return (
    <Link href={`/decks/${_id}`}>
      <div className="group relative flex h-[180px] overflow-hidden rounded-xl border border-border/50 bg-card/80 shadow-[var(--chrome-elevation-low)] transition-[border-color,box-shadow,background-color] duration-150 hover:border-[var(--chrome-deck-grid-border-hover)] hover:shadow-[var(--chrome-deck-grid-shadow-hover)]">
