...
export function CardDeckCountBadge() {
  ...
  return (
    ...
    >
      <div className="flex h-7 min-w-7 items-center justify-center rounded border border-primary bg-primary/90 px-2.5 text-sm font-bold text-primary-foreground shadow-[var(--chrome-badge-default-shadow)]">
        {deckCount}
      </div>
    </div>
  );
