Before implementing code, check to see if any of the available skills are going to be relevant to the task before implementing. If one of them is relevant, use it.
